...
```bash
curl -X POST "https://api.maycreator.com/api/campaigns"     -d "name"="Z1jGRNe6IYuWOhNp" \
    -d "description"="SYc2MHZh7IiGp8Er" \
    -d "image_url"="tDmONpDtMIgIDg7e" 
```
...
let body = JSON.stringify({
    "name": "Z1jGRNe6IYuWOhNp",
    "description": "SYc2MHZh7IiGp8Er",
    "image_url": "tDmONpDtMIgIDg7e",
})
...
curl -X POST "https://api.maycreator.com/api/campaigns/{campaign}"     -d "id"="9" \
    -d "name"="BmeKtdvrmQ8SHumu" \
    -d "description"="TIkXChHjzMHQSwrW" \
    -d "image_url"="liE75NO60GmC675m" 
```
...
let body = JSON.stringify({
    "id": "9",
    "name": "BmeKtdvrmQ8SHumu",
    "description": "TIkXChHjzMHQSwrW",
    "image_url": "liE75NO60GmC675m",
})
...
```bash
curl -X POST "https://api.maycreator.com/api/categories"     -d "name"="tRpZL6DjBUCxSKyZ" \
    -d "description"="EEjCgtcAdToH2TY9" \
    -d "image_url"="JFaSeDnBK3iiV2xI" 
```
...
let body = JSON.stringify({
    "name": "tRpZL6DjBUCxSKyZ",
    "description": "EEjCgtcAdToH2TY9",
    "image_url": "JFaSeDnBK3iiV2xI",
})
...
curl -X POST "https://api.maycreator.com/api/categories/{category}"     -d "id"="9" \
    -d "name"="45RacXwqUHmo3HO9" \
    -d "description"="7mJW3Heeq3BOw4T9" \
    -d "image_url"="yObMBInRB2HgSfSY" 
```
...
let body = JSON.stringify({
    "id": "9",
    "name": "45RacXwqUHmo3HO9",
    "description": "7mJW3Heeq3BOw4T9",
    "image_url": "yObMBInRB2HgSfSY",
})
...
```bash
curl -X POST "https://api.maycreator.com/api/comments"     -d "user_id"="4" \
    -d "product_id"="19" \
    -d "comment"="lYYXvsdHz39a3kpk" \
    -d "stars"="1" 
```
...
curl -X POST "https://api.maycreator.com/api/comments/{comment}"     -d "id"="9" \
    -d "user_id"="10" \
    -d "product_id"="17" \
    -d "comment"="ZzCrvD6NfWfFcL9B" \
    -d "stars"="53015104.316933" 
```
...
let body = JSON.stringify({
    ...
    "user_id": "10",
    "product_id": "17",
    "comment": "ZzCrvD6NfWfFcL9B",
    "stars": "53015104.316933",
})
...
```bash
curl -X POST "https://api.maycreator.com/api/companies"     -d "name"="cVkUG8X0WHBtAQAC" \
    -d "address"="dhhKBcRyALcBPgWK" \
    -d "phone"="rcSG08eCUCZc7OBs" \
    -d "logo"="grzRhe39XGzjOTWu" \
    -d "working_hours_day"="9XnAafl64MKD6l09" \
    -d "working_hours_night"="kvRmHLmes4LsxpVw" \
    -d "facebook"="u1GNWYgRMzSqOya3" \
    -d "twitter"="7TlkpBe6QMvsuK8r" \
    -d "instagram"="xMPXV5BjJAYElos1" \
    -d "about_text"="nPqZLfaMcrxlUJ1q" \
    -d "about_image"="2V8TMbe9pZMDj7Cy" \
    -d "locationy"="waA4FKb5ywz42QAQ" \
    -d "locationx"="ASh3C3Sr1Lpa2sP8" 
```
...
let body = JSON.stringify({
    "name": "cVkUG8X0WHBtAQAC",
    "address": "dhhKBcRyALcBPgWK",
    "phone": "rcSG08eCUCZc7OBs",
    "logo": "grzRhe39XGzjOTWu",
    "working_hours_day": "9XnAafl64MKD6l09",
    "working_hours_night": "kvRmHLmes4LsxpVw",
    "facebook": "u1GNWYgRMzSqOya3",
    "twitter": "7TlkpBe6QMvsuK8r",
    "instagram": "xMPXV5BjJAYElos1",
    "about_text": "nPqZLfaMcrxlUJ1q",
    "about_image": "2V8TMbe9pZMDj7Cy",
    "locationy": "waA4FKb5ywz42QAQ",
    "locationx": "ASh3C3Sr1Lpa2sP8",
})
...
```bash
curl -X POST "https://api.maycreator.com/api/companies/{company}"     -d "name"="yloQvjAfq7TnWj4t" \
    -d "address"="p7zCHICFMr3grdZp" \
    -d "phone"="qORj715x3PELMU5k" \
    -d "logo"="ScWdTfWJxe1rVDIm" \
    -d "working_hours_day"="Unoz3pBjCsBCDsua" \
    -d "working_hours_night"="DtWKM6CeI3aED08i" \
    -d "facebook"="mvVoSf1ZtvQZVI8A" \
    -d "twitter"="Xo5aiE3EYkKwRqNj" \
    -d "instagram"="CeoIN4mlS4PJPtp9" \
    -d "about_text"="QO8T4cheePQqJYNp" \
    -d "about_image"="00cqztjUjXL9i2wN" \
    -d "locationy"="soM5MoYqSjkJUpVP" \
    -d "locationx"="khSvl1xOryHtKSlb" 
```
...
let body = JSON.stringify({
    "name": "yloQvjAfq7TnWj4t",
    "address": "p7zCHICFMr3grdZp",
    "phone": "qORj715x3PELMU5k",
    "logo": "ScWdTfWJxe1rVDIm",
    "working_hours_day": "Unoz3pBjCsBCDsua",
    "working_hours_night": "DtWKM6CeI3aED08i",
    "facebook": "mvVoSf1ZtvQZVI8A",
    "twitter": "Xo5aiE3EYkKwRqNj",
    "instagram": "CeoIN4mlS4PJPtp9",
    "about_text": "QO8T4cheePQqJYNp",
    "about_image": "00cqztjUjXL9i2wN",
    "locationy": "soM5MoYqSjkJUpVP",
    "locationx": "khSvl1xOryHtKSlb",
})
...
```bash
curl -X POST "https://api.maycreator.com/api/employees"     -d "name"="HOvlosXtjPJm78fk" \
    -d "surname"="xAv5nO1NHyQ59ICk" \
    -d "description"="aGc5A77I5nTZHxE0" \
    -d "image_url"="Iesrp2X0LHfrPU8L" 
```
...
let body = JSON.stringify({
    "name": "HOvlosXtjPJm78fk",
    "surname": "xAv5nO1NHyQ59ICk",
    "description": "aGc5A77I5nTZHxE0",
    "image_url": "Iesrp2X0LHfrPU8L",
})
...
curl -X POST "https://api.maycreator.com/api/employees/{employee}"     -d "id"="9" \
    -d "name"="ucIiC41FJctthsgw" \
    -d "surname"="dYwpGdUhThq50qaH" \
    -d "description"="sxA5UbNayZrsPomB" \
    -d "image_url"="SaXON5IxKoSeSZ49" 
```
...
let body = JSON.stringify({
    "id": "9",
    "name": "ucIiC41FJctthsgw",
    "surname": "dYwpGdUhThq50qaH",
    "description": "sxA5UbNayZrsPomB",
    "image_url": "SaXON5IxKoSeSZ49",
})
...
```bash
curl -X POST "https://api.maycreator.com/api/messages"     -d "name"="TuxKgk32QX7l4fn2" \
    -d "about"="KJEC1XaUbQ2xQGXY" \
    -d "message"="SoLRZxrjcGvmtSJQ" \
    -d "phone"="EoifXswrBuxampSm" 
```
...
let body = JSON.stringify({
    "name": "TuxKgk32QX7l4fn2",
    "about": "KJEC1XaUbQ2xQGXY",
    "message": "SoLRZxrjcGvmtSJQ",
    "phone": "EoifXswrBuxampSm",
})
...
curl -X POST "https://api.maycreator.com/api/messages/{message}"     -d "id"="9" \
    -d "name"="Mr5j1a0KEuOcapAU" \
    -d "about"="sCOzMhtxLnXAUg6h" \
    -d "message"="2RGViwkWwQXfafsp" \
    -d "phone"="LOymxaJsGgDbt5Yz" 
```
...
let body = JSON.stringify({
    "id": "9",
    "name": "Mr5j1a0KEuOcapAU",
    "about": "sCOzMhtxLnXAUg6h",
    "message": "2RGViwkWwQXfafsp",
    "phone": "LOymxaJsGgDbt5Yz",
})
...
curl -X POST "https://api.maycreator.com/api/orders"     -d "user_id"="6" \
    ...
    -d "status"="17" \
    -d "price"="JVAojOgJ5YOz15mk" \
    -d "note"="Gj283CpPyex0y2DF" \
    -d "date_ordered"="5gbN0Q5FjjeoiCF3" \
    -d "currency"="dwzRqQNxumEZ2z5P" \
    -d "payment_type_id"="10" 
```
...
let body = JSON.stringify({
    ...
    "user_contact_id": "17",
    "status": "17",
    "price": "JVAojOgJ5YOz15mk",
    "note": "Gj283CpPyex0y2DF",
    "date_ordered": "5gbN0Q5FjjeoiCF3",
    "currency": "dwzRqQNxumEZ2z5P",
    "payment_type_id": "10",
})
...
curl -X POST "https://api.maycreator.com/api/orders/{order}"     -d "id"="9" \
    ...
    -d "user_contact_id"="17" \
    -d "status"="7" \
    -d "price"="ICbpveiuogkWZivF" \
    -d "note"="lO1SrACjYJSUnuQv" \
    -d "date_ordered"="8QfhthsVZY4CjbMX" \
    -d "currency"="OMzGtvmJIYPEkNXK" \
...
let body = JSON.stringify({
    ...
    "user_contact_id": "17",
    "status": "7",
    "price": "ICbpveiuogkWZivF",
    "note": "lO1SrACjYJSUnuQv",
    "date_ordered": "8QfhthsVZY4CjbMX",
    "currency": "OMzGtvmJIYPEkNXK",
    "payment_type_id": "18",
})
...
```bash
curl -X POST "https://api.maycreator.com/api/products"     -d "name"="roEvhZqrhqVxOK59" \
    -d "description"="vgw3SSIgk2p17c86" \
    -d "image_url"="hXfV4jFHceWZNOru" \
    -d "category_id"="1" \
    -d "price"="aPuCNizc2kKl53gn" 
```
...
let body = JSON.stringify({
    "name": "roEvhZqrhqVxOK59",
    "description": "vgw3SSIgk2p17c86",
    "image_url": "hXfV4jFHceWZNOru",
    "category_id": "1",
    "price": "aPuCNizc2kKl53gn",
})
...
curl -X POST "https://api.maycreator.com/api/products/{product}"     -d "id"="9" \
    -d "name"="4zGQ32Cqkqcfe3Uf" \
    -d "description"="fnV0po7YqfiDkpta" \
    -d "image_url"="BW9tXKnujawkRj1N" \
    -d "category_id"="2" \
    -d "price"="hzuoOLwEMbLXNzcC" 
```
...
let body = JSON.stringify({
    "id": "9",
    "name": "4zGQ32Cqkqcfe3Uf",
    "description": "fnV0po7YqfiDkpta",
    "image_url": "BW9tXKnujawkRj1N",
    "category_id": "2",
    "price": "hzuoOLwEMbLXNzcC",
})
...
```bash
curl -X POST "https://api.maycreator.com/api/reservations"     -d "reservation_date"="KoZzk8U1b4gKD7f9" \
    -d "reservation_hour"="aDy4r5nrrQ0RlyBi" \
    -d "people_count"="20" \
    -d "name"="jppSa2m4GLYAPplB" \
    -d "surname"="q4c0biwYbYlx9v2g" \
    -d "phone"="2oECnyAhNdWm9hsx" \
    -d "note"="ECLyatPaaMBhZGEG" 
```
...
let body = JSON.stringify({
    "reservation_date": "KoZzk8U1b4gKD7f9",
    "reservation_hour": "aDy4r5nrrQ0RlyBi",
    "people_count": "20",
    "name": "jppSa2m4GLYAPplB",
    "surname": "q4c0biwYbYlx9v2g",
    "phone": "2oECnyAhNdWm9hsx",
    "note": "ECLyatPaaMBhZGEG",
})
...
curl -X POST "https://api.maycreator.com/api/reservations/{reservation}"     -d "id"="9" \
    -d "reservation_date"="fyU20JQQ1F0nTCKY" \
    -d "reservation_hour"="b8RtQQMkyrS6OZLK" \
    -d "people_count"="2" \
    -d "name"="UYVXuBN1uT5ZkgIZ" \
    -d "surname"="GHODW8hLJxx3QXuB" \
    -d "phone"="kUbWedcOR7KCI4El" \
    -d "note"="iAFOq5yquyG5YgvB" 
```
...
let body = JSON.stringify({
    "id": "9",
    "reservation_date": "fyU20JQQ1F0nTCKY",
    "reservation_hour": "b8RtQQMkyrS6OZLK",
    "people_count": "2",
    "name": "UYVXuBN1uT5ZkgIZ",
    "surname": "GHODW8hLJxx3QXuB",
    "phone": "kUbWedcOR7KCI4El",
    "note": "iAFOq5yquyG5YgvB",
})
...
curl -X POST "https://api.maycreator.com/api/userContacts"     -d "user_id"="5" \
    -d "name"="9oZdzvvSrWIc23NX" \
    -d "phone"="DKjbwMhn8BW0sNed" \
    -d "address"="IkhXDbNOxsOrYZJK" 
```
...
let body = JSON.stringify({
    "user_id": "5",
    "name": "9oZdzvvSrWIc23NX",
    "phone": "DKjbwMhn8BW0sNed",
    "address": "IkhXDbNOxsOrYZJK",
})
...
curl -X POST "https://api.maycreator.com/api/userContacts/{userContact}"     -d "id"="9" \
    -d "user_id"="4" \
    -d "name"="qpDDCRasiBG3tpeb" \
    -d "phone"="NjhdTEv8pHE0vG8r" \
    -d "address"="CZDdhJ9bACUQAkVp" 
```
...
let body = JSON.stringify({
    "id": "9",
    "user_id": "4",
    "name": "qpDDCRasiBG3tpeb",
    "phone": "NjhdTEv8pHE0vG8r",
    "address": "CZDdhJ9bACUQAkVp",
})
...
```bash
curl -X POST "https://api.maycreator.com/api/users"     -d "name"="AXuhSPhtXEVh3XdH" \
    -d "surname"="84oPGf0U5Lmd1iKH" \
    -d "email"="HrcULXb3Rv6k1nQ1" \
    -d "password"="3PareGdZiXox7R1R" \
    -d "password_confirmation"="SzCQ5MaSQzrfwfD5" \
    -d "status"="Ilpg12gunZH1KwGP" 
```
...
let body = JSON.stringify({
    "name": "AXuhSPhtXEVh3XdH",
    "surname": "84oPGf0U5Lmd1iKH",
    "email": "HrcULXb3Rv6k1nQ1",
    "password": "3PareGdZiXox7R1R",
    "password_confirmation": "SzCQ5MaSQzrfwfD5",
    "status": "Ilpg12gunZH1KwGP",
})
...
curl -X POST "https://api.maycreator.com/api/users/{user}"     -d "id"="9" \
    -d "name"="Xijf7IPUl8zttKAq" \
    -d "surname"="HRNPMO9wYQq4FSha" \
    -d "email"="lp6htNsnlvCdwbOL" \
    -d "password"="dJ7FZE2sdBk3OLdM" \
    -d "password_confirmation"="0q7P3ZUoTSWubIoe" \
    -d "status"="5qDUAfBe4IMyiBLc" 
```
...
let body = JSON.stringify({
    "id": "9",
    "name": "Xijf7IPUl8zttKAq",
    "surname": "HRNPMO9wYQq4FSha",
    "email": "lp6htNsnlvCdwbOL",
    "password": "dJ7FZE2sdBk3OLdM",
    "password_confirmation": "0q7P3ZUoTSWubIoe",
    "status": "5qDUAfBe4IMyiBLc",
})
...
```bash
curl -X POST "https://api.maycreator.com/api/login"     -d "email"="mP6xoQ9tCnFANh7R" \
    -d "password"="VDrMF5cyoJEYQpbb" 
```
...
let body = JSON.stringify({
    "email": "mP6xoQ9tCnFANh7R",
    "password": "VDrMF5cyoJEYQpbb",
})
...
```bash
curl -X POST "https://api.maycreator.com/api/register"     -d "name"="lGRbS7XNkQ42mXCc" \
    -d "surname"="eAhzyUrUy39eSgMq" \
    -d "email"="gfkyErtL4T45KfOl" \
    -d "password"="7ixok3XD3NvdT4kj" \
    -d "password_confirmation"="ax4AtqiVLBgShzL0" 
```
...
let body = JSON.stringify({
    "name": "lGRbS7XNkQ42mXCc",
    "surname": "eAhzyUrUy39eSgMq",
    "email": "gfkyErtL4T45KfOl",
    "password": "7ixok3XD3NvdT4kj",
    "password_confirmation": "ax4AtqiVLBgShzL0",
})
